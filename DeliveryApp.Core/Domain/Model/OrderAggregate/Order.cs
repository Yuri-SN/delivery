...
public class Order : Aggregate<Guid>
{
    ...
    public UnitResult<Error> Assign(Courier courier)
    {
        ...
        if (Status == OrderStatus.Completed) return GeneralErrors.ValueIsRequired(nameof(courier));
        if (Status == OrderStatus.Assigned) return GeneralErrors.ValueIsRequired(nameof(courier));
